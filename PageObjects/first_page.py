...
class FirstPage(BasePage):
    ...
    def addition(self, first, second):
        ...
        # input text
        self.input_text(
            first, "input first number in the first page", loc.first_number_loc)
        # waiting for the element
        self.wait_eleVisible(loc.second_number_loc)
        # input text
        self.input_text(
            second, "input second number in the first page", loc.second_number_loc)
        self.wait_eleVisible(loc.add_button_loc)
    ...
    def login(self, username):
        ...
        self.wait_eleVisible(loc.login_button_loc)
